    ...
    <div class="footer-w">
        <div class="footer-left">
            <?php if ($this->options->ftGithub) : ?>
                <a href="https://github.com/<?php echo urlencode($this->options->ftGithub) ?>" target="_blank" class="mdl-button mdl-js-button mdl-button--icon" id="ft-github">
            ...
            <?php if ($this->options->ftQQ) : ?>
                <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo urlencode($this->options->ftQQ) ?>&amp;site=qq&amp;menu=yes" target="_blank" class="mdl-button mdl-js-button mdl-button--icon" id="ft-qq">
            ...
            <?php if ($this->options->ftWeibo) : ?>
                <a href="<?php $this->options->ftWeibo(); ?>" target="_blank" class="mdl-button mdl-js-button mdl-button--icon" id="ft-Weibo">
            ...
            <?php if ($this->options->ftEmail) : ?>
                <a href="mailto:<?php $this->options->ftEmail(); ?>" target="_blank" class="mdl-button mdl-js-button mdl-button--icon" id="ft-email">
        ...
        <div class="footer-center" style="text-align: center">
            <?php if ($this->options->siteTime) : ?>
                已运行 &nbsp; <span id="build-time"></span><br>
            <?php endif; ?>
            <div>
                ...
                <a class="mdl-color-text--primary anim-line" style="opacity: 0.9" href="<?php $this->options->siteUrl(); ?>">
        ...
        <div class="footer-right" style="text-align: end">
            ...
            <br>
            <?php _e('Typecho'); ?>
            <script type="text/javascript" src="https://s9.cnzz.com/z_stat.php?id=1277981579&web_id=1277981579"></script>
        </div>
    </div>

    <button id="to_top" class="mdl-button mdl-js-button mdl-button--mini-fab mdl-button--fab mdl-js-ripple-effect mdl-button--primary hover-shadow--6dp hover--margin-top-1px">
...
<script>
    $(function() {
        ...
        $(document).on('submit', '#search,#drawer-search', function(event) {
            ...
            $.pjax.submit(event, '#page-content', {
                timeout: 10000
            });
        });
