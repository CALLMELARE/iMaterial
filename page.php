...
<div style="max-width: 900px;" class="translation-all-1_5 <?php if (!$this->fields->rmTree && $treeMenu) : ?>mdl-cell--9-col mdl-cell--6-col-tablet<?php else : ?>mdl-cell--11-col mdl-cell--8-col-tablet<?php endif; ?>">
    <div class="post-card page-post-card mdl-card mdl-cell mdl-shadow--2dp hover-shadow--4dp
             mdl-cell--12-col">
        <?php $postThumb = getPostThumb($this);
        if (!$postThumb) : $postThumb = $this->fields->card_image;
        endif; ?>
        <?php if ($postThumb) : ?>
            <div class="mdl-card__title has-image">
                <a class="has-image-img"><img alt="" src="<?php echo $postThumb; ?>"></a>
                <!--about page [contact]-->
                <?php if ($this->is('page', 'about')) : $this->need('contact.php');
                    endif; ?>
            </div>
        <?php else : ?>
        ...
        <div class="mdl-card__supporting-text color-text-block-primary">
            <div class="card-text-wrapper" style="margin: 0 0 16px 0;padding: 0;">
                ...
                <div class="post-meta2">
                    <time class="" datetime="<?php $this->date('c'); ?>" itemprop="datePublished">
                        <?php $this->date('Y/m/d'); ?>
                    </time>
                </div>
            </div>
            ...
            <div class="article-content markdown">
                ...
                <?php if ($this->is('page', 'board')) : ?>
                    <?php $this->avatars('span', 'friend-wall image-no-show');
                        /**插件：http://www.yzmb.me/archives/net/avatars-for-typecho*/ ?>
                    <script>
            ...
            <div class="tag-wrapper">
                <?php foreach ($this->tags as $tag) : ?>
                    <a style="margin-right: 8px;" class="anim-line" href="<?php echo $tag['permalink']; ?>">#<?php echo $tag['name']; ?></a>
                <?php endforeach; ?>
            </div>
        </div>
