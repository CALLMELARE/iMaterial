...
<body style="">
    <div class="mdl-layout mdl-js-layout">
        <header class="mdl-color-text--grey-700">
            <div aria-expanded="false" role="button" tabindex="0" class="mdl-layout__drawer-button" style="display: none">
            ...
            <a href="<?php $this->options->adminUrl(); ?>" id="show-login-dialog" target="_blank" class="mdl-cell--hide-phone mdl-button mdl-js-button mdl-button--icon no-pjax" style="margin-left: 16px;">
        ...
        <main class="mdl-layout__content" id="mdl-layout-content" style="background-image: url('<?php $this->options->themeUrl('css/style.css'); ?>');">
            <div id="page-content" class="page-content mdl-grid <?php if (($this->options->homeType && $this->options->homeType == 'type1')) : echo ' page-content-type1';
                                                                endif; ?>">